...
<div class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 overflow-hidden">
    ...
    <div class="relative w-full max-w-4xl min-h-[560px] bg-white dark:bg-gray-900 rounded-3xl shadow-xl overflow-hidden flex">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePassword('login-password')"
                            class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-coral">
        ...
        {{-- PANEL REGISTER --}}
        <div id="panel-register" class="w-full md:w-1/2 px-10 py-12 flex flex-col justify-center absolute md:relative inset-0 z-10"
        ...
        {{-- PANEL GAMBAR --}}
        <div id="panel-image" class="hidden md:flex w-1/2 flex-col items-center justify-center p-10 absolute right-0 top-0 bottom-0 z-20 overflow-hidden" style="background-color: #2b2b2b;">
            <img src="{{ asset('images/wedding-hero.jpg') }}"
                 alt="Wedding"
                 class="w-full h-full object-cover opacity-25 absolute inset-0">
            <div class="relative z-10 text-center text-white">
                <h2 id="image-title" class="text-2xl font-bold mb-2">Belum punya akun?</h2>
                <p id="image-sub" class="text-sm opacity-80 mb-6 leading-relaxed">Daftar sekarang dan mulai<br>kelola acaramu</p>
                <button id="image-btn" onclick="switchToRegister()"
                    class="border-2 border-white text-white font-semibold px-6 py-2 rounded-full hover:bg-white hover:text-gray-900 transition text-sm tracking-wide">
                    Daftar
                </button>
            </div>
        </div>
...
<script>
    function switchToRegister() {
        ...
        document.getElementById('image-sub').innerHTML = 'Masuk dan lanjutkan<br>perjalananmu';
    ...
    function switchToLogin() {
        ...
        document.getElementById('image-sub').innerHTML = 'Daftar sekarang dan mulai<br>kelola acaramu';
