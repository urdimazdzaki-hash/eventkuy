...
<div class="min-h-screen flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 px-6 py-10 max-w-6xl mx-auto">
    ...
    <div class="w-full max-w-md">
        ...
        <h2 class="text-3xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">Create Exceptional Events</h2>
        <p class="text-center text-gray-500 dark:text-gray-400 mb-6">Welcome to EventKuy</p>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                <input type="email" name="email" placeholder="Email" value="{{ old('email') }}"
                       class="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-coral">
            </div>

            <div class="relative">
                <input type="password" id="password" name="password" placeholder="Password"
                       class="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-coral">
            ...
            <div class="text-right text-sm">
                <a href="#" class="text-coral hover:underline">Forgot password?</a>
            </div>
        ...
        <p class="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <a href="{{ route('register') }}" class="text-coral hover:underline">Sign up</a>
        </p>
